...
export const ServerIcon = ({ className, filled = false, color = "currentColor" }: { className?: string; filled?: boolean, color?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect x="2" y="2" width="20" height="8" rx="2" ry="2" fill={filled ? color : 'none'} fillOpacity={filled ? 0.2 : 0} />
    <rect x="2" y="14" width="20" height="8" rx="2" ry="2" fill={filled ? color : 'none'} fillOpacity={filled ? 0.2 : 0} />
